...
export default async function GradesPage() {
  ...
  const { data: subjects } = await supabase.from('subjects').select('id, code, name').eq('user_id', user.id).is('archived_at', null).order('code');
