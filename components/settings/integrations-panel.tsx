      ...
      <div className="mt-6 grid gap-5">
        <article className="rounded-[1.5rem] bg-[#083f42] p-6 text-white shadow-[0_18px_40px_rgba(7,63,66,.16)]">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            {googleNeedsReconnect ? <a className="inline-flex min-h-11 items-center justify-center rounded-xl border border-white/25 px-4 py-2 font-bold text-white transition hover:bg-white/10" href="/api/integrations/google/start?consent=1">Reconnect Google account</a> : null}
