...
export function PlannerWorkspace({ tasks: initialTasks, currentTermId, terms, subjects, projects, focusedTaskId = null, approvedCategoryLabelsBySubject = {} }: PlannerWorkspaceProps) {
